...
func (g *Module) GenerateAndroidBuildActions(ctx android.ModuleContext) {
	...
	g.runCommand(ctx, g.outputFile, rawCommand)
}

func (g *Module) runCommand(ctx android.ModuleContext, out android.WritablePath, rawCommand string) {
